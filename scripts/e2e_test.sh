...
readonly REQUIRED_PATTERNS=(
  ...
  'msg="corpus minimization complete" package=stringutils target=FuzzUnSafeReverseString'
  'msg="corpus minimization complete" package=stringutils target=FuzzReverseString'
  'msg="corpus minimization complete" package=parser target=FuzzParseComplex'
  'msg="corpus minimization complete" package=parser target=FuzzEvalExpr'
  'msg="corpus minimization complete" package=tree target=FuzzBuildTree'
